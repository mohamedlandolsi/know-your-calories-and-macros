...
export const translations = {
  en: {
    ...
    caloricSurplus: 'Caloric surplus for muscle gain (up to 10% above maintenance)',
  ...
  fr: {
    ...
    caloricSurplus: 'Surplus calorique pour la prise de muscle (jusqu\'à 10% au-dessus du maintien)',
  ...
  ar: {
    ...
    caloricSurplus: 'فائض السعرات الحرارية لزيادة العضلات (حتى 10% فوق الصيانة)',
